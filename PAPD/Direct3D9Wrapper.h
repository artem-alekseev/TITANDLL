...
{
	public:
    typedef void(*tD3DCB_NOTIFY)(Direct3D9Wrapper* pD3DWrapper, Direct3DDevice9Wrapper* pD3DDeviceWrapper);
    typedef void(__stdcall *tD3D_CallBack)(Direct3D9Wrapper* _this);

    Direct3D9Wrapper(LPDIRECT3D9 pDirect3D) : pDirect3D9(pDirect3D), cbNotifyCreateDevice(0) { };
    ...
    void SetCallBack_NotifyCreateDevice(tD3DCB_NOTIFY callback) { this->cbNotifyCreateDevice = callback; };

  private:
    tD3DCB_NOTIFY cbNotifyCreateDevice;
