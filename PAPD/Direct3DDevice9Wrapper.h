...
{
  typedef void (*tD3D_CallBack)(Direct3DDevice9Wrapper* _this);

	public:
		Direct3DDevice9Wrapper(IDirect3DDevice9* pDirect3DDevice9, IDirect3D9* ppDirect3D9, D3DPRESENT_PARAMETERS* pPresentationParameters);
    ...
    void SetCallBack_BeginScene(tD3D_CallBack callback) { this->cbBeginScene = callback; };
    void SetCallBack_EndScene(tD3D_CallBack callback) { this->cbEndScene = callback; };
    void SetCallBack_Present(tD3D_CallBack callback) { this->cbPresent = callback; };
    void SetCallBack_Reset(tD3D_CallBack callback) { this->cbReset = callback; };
    
  private:
    tD3D_CallBack cbBeginScene;
    tD3D_CallBack cbEndScene;
    tD3D_CallBack cbPresent;
    tD3D_CallBack cbReset;
